...
export const authAPI = {
  ...
  sendSignupOTP: (data) => apiClient.post('/auth/signup/send-otp', data),
  verifySignup: (data) => apiClient.post('/auth/signup/verify', data),
  resendSignupOTP: (data) => apiClient.post('/auth/signup/resend-otp', data),
  verifyForgotPasswordOTP: (data) => apiClient.post('/auth/forgot-password/verify-otp', data),
};
